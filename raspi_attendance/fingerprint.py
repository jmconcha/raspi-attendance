...
def main():
    ...
    while True:
        print("----------------")
        if fprint_scan.finger.read_templates() != adafruit_fingerprint.OK:
            raise RuntimeError("Failed to read templates")
        print("Fingerprint templates:", fprint_scan.finger.templates)
        ...
        if c == "e":
            fprint_scan.enroll_finger(get_num())
        if c == "f":
        ...
        if c == "d":
            if fprint_scan.finger.delete_model(get_num()) == adafruit_fingerprint.OK:
                print("Deleted!")
            else:
